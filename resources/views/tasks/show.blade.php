    ...
    <div class="row">
        <div class="col">
            ...
            <div class="jumbotron pb-1">
                <h1 class="display-5 text-muted">{{ $task->title }}</h1>
                <hr class="my-4">
                ...
                <div class="row mb-3">
                    <div class="">
                        ...
                        <b class="badge">Важность:&nbsp;&nbsp;</b>
                        <span class="badge badge-danger">{{ !empty($task->priorities) ? $task->priorities : 'Не установлено'}}</span>
